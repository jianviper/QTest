...
// 		data=[{"name": "李四","type": "战士","value": "61412","date": "01-02"},{"name": "王二麻子","type": "魔法师","value": "51243","date": "01-03"},{"name": "王二麻子","type": "魔法师","value": "41243","date": "01-01"},{"name": "张三","type": "魔法师","value": "32312","date": "01-03"},{"name": "张三","type": "魔法师","value": "22312","date": "01-02"},{"name": "李四","type": "战士","value": "21412","date": "01-01"},{"name": "张三","type": "魔法师","value": "12312","date": "01-01"},{"name": "李四","type": "战士","value": "11412","date": "01-03"},{"name": "王二麻子","type": "魔法师","value": "11243","date": "01-02"}]
// 		console.log(data);
//         try {
//             draw(data);
//         } catch (error) {
...
function draw(data,dateStep) {
    ...
    var dateStep = String(dateStep);
    dateStep = dateStep.split('')[dateStep.length-1];
    ...
    if (showMessage) {
        ...
        var topInfo = g.insert("text")
            .attr("class", "growth")
            .attr("x", 0)
            .attr("y", text_y).text('当'+dateStep+itemLabel);

        // 右1文字
        g.insert("text")
            .attr("class", "growth")
            .attr("x", text_x)
            .attr("y", text_y).text(typeLabel+'('+dateStep+')');
